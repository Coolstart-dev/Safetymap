...
export default function ReportModal({ 
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent 
        className="glass-modal w-full max-w-4xl max-h-[95dvh] overflow-hidden p-0 rounded-2xl"
        style={isIOS() ? {
          position: 'fixed',
          top: '2.5%',
          left: '50%',
                  ...
                  <FormControl>
                    <RadioGroup onValueChange={field.onChange} value={field.value}>
                      <div className="space-y-2">
                        ...
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="witness" id="witness" />
                          <Label htmlFor="witness">I witnessed this incident</Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="reporter" id="reporter" />
                          <Label htmlFor="reporter">I'm reporting this secondhand</Label>
                        </div>
                      </div>
                    </RadioGroup>
                  </FormControl>
